...
public class ConcertSeatController {
  ...
  @PostMapping("/select")
  public List<UUID> selectConcertSeats(@RequestBody List<UUID> concertIds){
    log.info("concertIds : {}", concertIds.get(0));
    return concertSeatService.selectConcertSeats(concertIds);
  }
}
